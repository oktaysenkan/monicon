...
Monicon can generate SVG icons for any project, regardless of the programming language. This guide shows you how to use Monicon as a build step to generate SVG files that can be used in Go, Rust, Python, PHP, or any other language.
...
```ts twoslash title="generate-icons.js"
import { bootstrap } from "@monicon/core";
