...
The Monicon CLI provides a command-line interface for generating icons. This enables you to use Monicon as framework-agnostic and tool-agnostic.
...
```bash tab="npm"
npm install -g @monicon/core
```

```bash tab="pnpm"
pnpm add -g @monicon/core
```

```bash tab="yarn"
yarn add -g @monicon/core
```

```bash tab="bun"
bun add -g @monicon/core
```
